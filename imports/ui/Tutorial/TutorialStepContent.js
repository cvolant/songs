      ...
      body: isAutenticated =>
        <React.Fragment>
          <Trans i18nKey='tutorial.globalNavigation.1'>
            Click the logo to expand/shrink the menu buttons. Click the menu icon <InlineIcon Icon={Menu} /> to open the full menu.
          </Trans>
          <br />
          {isAutenticated ?
            ...
            <Trans i18nKey='tutorial.globalNavigation.unAuth'>
              You must be signed in to access your personnal space, data, songlists, ... Click the personnal space icon <InlineIcon Icon={Person} /> to sign in.
            </Trans>
          }
        </React.Fragment>,
    },
    ...
    sortList: {
      ...
      body: () =>
        <Trans i18nKey='tutorial.sortList.1'>
          In the advanced options, you will find a "sort" button. Click on it to enable sorting.<br />
          A sorting header will appear above the list: click on a sorting option to sort the list, and a second time to sort in reverse order.<br />
          Click a third time to remove this sorting, or on the close icon <InlineIcon Icon={Clear} /> to leave the sorting options.
        </Trans>,
    },
    chooseSong: {
        ...
        <React.Fragment>
          {isAutenticated ?
            <Trans i18nKey='tutorial.favorites.auth'>
              In the list, you can also click the "Favorite" icon <InlineIcon Icon={FavoriteBorder} /> of a song to mark it as a favorite. Click once again to unmark it.<br />
              Among the advanced search options, a "Favorites" button allows you to only display your favorites songs.
            </Trans>
            :
            <Trans i18nKey='tutorial.favorites.unAuth'>
              When you are connected, you can mark the songs you like as favorites, and display only your favorite songs thanks to a new advanced search option.
            </Trans>
          }
        </React.Fragment>,
    },
